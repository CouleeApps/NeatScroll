#include "../stdafx.h"
#include "TaskViewOpenPerformer.h"
#include "../TaskViewDetector.h"
#include <Windows.h>

bool TaskViewOpenPerformer::onGestureStart(const Movement &movement) {
...
bool TaskViewOpenPerformer::onGestureMove(const Movement &movement) {
	return true;
}

bool TaskViewOpenPerformer::onGestureStop(const Movement &movement) {
	return true;
}